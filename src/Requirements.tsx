    ...
    return (
      <div>
        ...
        <ol>
          ...
          <li>
            When clicking the timer button it should start counting up from
            00:00 with a precision of one second.
            <br />
          ...
          <li>
            When clicking the button again the timer should start back at step
            2.
          </li>
        </ol>
      </div>
